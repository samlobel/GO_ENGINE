...
def train_convbot_on_randoms(batch_num=0):
  ...
  load_path = None
  save_path = './saved_models/more_basic_convnet/trained_on_' + str(1) + '_batch.ckpt'
  if batch_num != 0:
    load_path = './saved_models/more_basic_convnet/trained_on_' + str(batch_num) + '_batch.ckpt'
    save_path = './saved_models/more_basic_convnet/trained_on_' + str(batch_num+1) + '_batch.ckpt'
