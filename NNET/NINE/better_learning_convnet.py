...
class Better_Learner_ConvBot(GoBot):
...
def train_convbot_on_randoms(batch_num=0):
  ...
  load_path = None
  save_path = './saved_models/better_learning_convnet/trained_on_' + str(1) + '_batch.ckpt'
  if batch_num != 0:
    load_path = './saved_models/better_learning_convnet/trained_on_' + str(batch_num) + '_batch.ckpt'
    save_path = './saved_models/better_learning_convnet/trained_on_' + str(batch_num+1) + '_batch.ckpt'

  b_c = Better_Learner_ConvBot(load_path=load_path)
  # for i in xrange(10):
...
def train_and_save_from_empty_input(batch_num=0):
  ...
  c_b = Better_Learner_ConvBot(load_path=load_path)
