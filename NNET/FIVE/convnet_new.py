...
def play_game(load_data_1, load_data_2):
  ...
  convbot_one = Convbot_FIVE_NEW(folder_name=folder_1, batch_num=batch_num_1)
  convbot_two = Convbot_FIVE_NEW(folder_name=folder_2, batch_num=batch_num_2)
