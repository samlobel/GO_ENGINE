...
class Board:
  ...
  def reset(self):
    ...
    if self.board_metadata['black_player'] == 'AI':
      self.board_metadata['black_AI'] = Convbot_NINE_POLICY_MOVETRAINED(folder_name="1", batch_num=101)
    ...
    if self.board_metadata['white_player'] == 'AI':
      self.board_metadata['white_AI'] = Convbot_NINE_POLICY_MOVETRAINED(folder_name="1", batch_num=30)
